# -*- coding: utf-8 -*-
"""
Created on Tue Oct 28 2016
under construction / pooling implementation on all devices in a unique thread
...
class readValuesObj(QtCore.QObject):
...
# ---> ---> SETUP tab
        ...
        self.autoMeasPrince.clicked.connect(self.autoMeasureLockin)
        self.autoOffsetPrince.clicked.connect(self.autoOffsetLockin)
...
# ---> ---> MAGNETIC MEASUREMENTS tab
    ...
    def chooseWorkDir(self):
        self.workDir = str(QtGui.QFileDialog.getExistingDirectory(self,"Select your working directory","D:\DEMAG-MOKE\DATA"))+'/'
...
# ----> magnetic field control functions
    ...
    def hyst_scan(self):
        ...
        #self.hystObj.endRun.connect(self.startFieldTimer)
        ...
        self.graphicsViewFieldSingle.showGrid(x=True,y=True)
        self.graphicsViewFieldSingle.setLabel('bottom', "Field", units='mT')
        ...
        self.graphicsViewFieldMulti.setLabel('bottom', "Field", units='mT')
...
# ----> LockIn control functions
    ...
    def updateLockinLabels(self,read_magnitude,read_phase):
        self.readPrincexSetup.setText(read_magnitude)
        self.readPrinceySetup.setText(read_phase)
    def startLockinTimer(self):
        self.readLockinTimer.start()
    def stopLockinTimer(self):
        self.readLockinTimer.stop()
    def autoMeasureLockin(self):
        self.lockin.auto_lockin()
    def autoOffsetLockin(self):
        self.lockin.auto_offset()
